...
export type View = 'HOME' | 'CHECKOUT' | 'SUCCESS' | 'PROFILE' | 'WISHLIST' | 'ORDERS' | 'GIFT_CARDS' | 'REFUNDS' | 'SAVED_ADDRESSES' | 'REWARDS' | 'PAYMENT_MANAGEMENT' | 'SUGGEST_PRODUCTS' | 'NOTIFICATIONS' | 'GENERAL_INFO' | 'PRODUCT_DETAIL' | 'INFO_PAGE' | 'ADMIN' | 'ANALYTICS';