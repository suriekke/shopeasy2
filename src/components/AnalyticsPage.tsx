...
const AnalyticsPage: React.FC = () => {
  ...
  const fetchAnalytics = async () => {
    try {
      const data = await firestoreService.getAnalytics();
      setAnalytics(data);
    } catch (error) {
        ...
        <div className="p-6">
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-sm text-gray-600">New order #123456 received</span>
              <span className="text-xs text-gray-400">2 minutes ago</span>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-2 h-2 bg-blue-500 rounded-full"></div>
              <span className="text-sm text-gray-600">Product "Fresh Tomatoes" stock updated</span>
